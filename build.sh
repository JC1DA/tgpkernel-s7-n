...
echo "- Building system-r12p0.tar.xz file ..."
cd $ZIPDIR/tgpkernel/system-r12p0
tar -cf - system/ | xz -9 -c - > system-r12p0.tar.xz
mv -f system-r12p0.tar.xz $ZIPDIR/tgpkernel/files/system-r12p0.tar.xz
cd ..
rm -rf $ZIPDIR/tgpkernel/system-r12p0
...
echo ""
echo "Building S7 r12p0 .img files"
echo "----------------------------"
echo ""
S7N=1
git checkout tw70 -f
